...
def fillTab2():
    ...
    gridLayout = QtWidgets.QGridLayout(analysis_tab)
    gridLayout.setObjectName("gridLayout")
    plugin_label = QtWidgets.QLabel(analysis_tab)
    ...
    plugin_comboBox = QtWidgets.QComboBox(analysis_tab)
    ...
    static_anal_label = QtWidgets.QLabel(analysis_tab)
    ...
    static_run_button = QtWidgets.QPushButton(analysis_tab)
    ...
    dynamic_anal_label = QtWidgets.QLabel(analysis_tab)
    ...
    horizontalLayout.addWidget(search_image_lable)
    gridLayout_6.addLayout(horizontalLayout, 1, 1, 1, 1)
    scrollArea = QtWidgets.QScrollArea(analysis_tab)
    ...
    poi_title_label = QtWidgets.QLabel(analysis_tab)
    ...
    a_pushButton = QtWidgets.QPushButton(analysis_tab)
    ...
    scrollArea_2 = QtWidgets.QScrollArea(analysis_tab)
    ...
    o_pushButton = QtWidgets.QPushButton(analysis_tab)
    ...
    detailed_poi_view_label = QtWidgets.QLabel(analysis_tab)
    ...
    search_image_lable.setText(_translate("MainWindow", "TextLabel"))
